            ...
            <div className="admin-card">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <textarea name="desc" rows="4" placeholder="Description of the spice..." onChange={handleChange} required />
                    </div>
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                <input name="color" type="color" onChange={handleChange} value={inputs.color || "#e21f26"} style={{ width: '50px', padding: '5px', height: '45px' }} />
                                <input name="color" type="text" placeholder="#e21f26" value={inputs.color || ""} onChange={handleChange} />
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" className="admin-btn" style={{ width: '100%', marginTop: '20px' }}>Create Product</button>
                </form>
            </div>
        </div>
    );
