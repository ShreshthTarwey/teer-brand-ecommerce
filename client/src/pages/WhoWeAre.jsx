    ...
    <div className="who-we-are-page">
      ...
      <section className="company-infrastructure">
        <div className="section-header">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="#ec3136" width="38%" height="90" viewBox="0 0 50 40" stroke="#ec3136" strokeWidth="1" preserveAspectRatio="none" style={{ height: '10px' }}>
            <polygon points="0,0 0,50 50,50"></polygon>
          </svg>
        </div>
